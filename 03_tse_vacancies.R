...
save(vacancies2006, file = 'vacancies2006.Rda')
save(vacancies2008, file = 'vacancies2008.Rda')
save(vacancies2010, file = 'vacancies2010.Rda')
save(vacancies2012, file = 'vacancies2012.Rda')
save(vacancies2014, file = 'vacancies2014.Rda')
save(vacancies2016, file = 'vacancies2016.Rda')
save(vacancies, file = 'vacancies.Rda')