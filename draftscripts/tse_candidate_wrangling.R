...
lapply(paste0('../2018 TSE Databank/', years[1:3]), unzip, exdir = 'tse/txt')
...
names(candidates.upto.2010) <- candidates.2010.columns
...
# Save datasets
save(candidates.upto.2010, file = './data/candidates.upto.2010.Rda')
